...
import 'package:islami2/screens/quran_screen/chapter_name.dart';
      ...
      children: [
        ...
        Expanded(
            child:ListView.separated(
                itemBuilder: (context , index) => ChapterName(name: suraNames[index], versesNumber: versesNumber[index].toString(), index: index),
